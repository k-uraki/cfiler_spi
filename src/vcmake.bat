...
REM Python 3.8
REM SET PYTHON_ROOT=C:\Python38-32
REM SET PYTHON_LIB_FILENAME=python38.lib

REM Python 3.8 64bit
...
REM link /INCREMENTAL:NO /NOLOGO /LIBPATH:%PYTHON_ROOT%\libs /MACHINE:X86 /DLL /OUT:spi.pyd %PYTHON_LIB_FILENAME% spi.obj
link /INCREMENTAL:NO /NOLOGO /LIBPATH:%PYTHON_ROOT%\libs /MACHINE:%ARCH% /DLL /OUT:spi.pyd %PYTHON_LIB_FILENAME% spi.obj
